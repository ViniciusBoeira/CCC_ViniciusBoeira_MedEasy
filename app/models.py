...
# [SEGURANÇA] generate_password_hash() transforma uma senha em texto puro num hash scrypt seguro.
# check_password_hash() compara uma senha digitada com um hash armazenado sem precisar decifrar o hash.
